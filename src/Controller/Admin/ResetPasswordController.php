...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordEncoderInterface $passwordEncoder, string $token = null): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('procesos_inicio');
        }
    ...
    {
        $user = $this->getDoctrine()->getRepository(FosUser::class)->findOneBy([
            'email' => $emailFormData,
        ]);
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('martin.ibarra@xolos.com.mx', 'Club Tijuana Xoloitzcuintles de Caliente - Mailer'))
            ->to($user->getEmail())
