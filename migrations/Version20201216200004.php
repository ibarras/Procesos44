 ...
 */
final class Version20201216200004 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        //$this->addSql('CREATE TABLE ic_pago_proyectado (id INT NOT NULL, id_patrocinador INT NOT NULL, fecha_pago_proyectado DATE DEFAULT NULL, fecha_limite_pago DATE DEFAULT NULL, monto NUMERIC(10, 2) DEFAULT NULL, PRIMARY KEY(id))');
